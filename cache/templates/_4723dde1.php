    ...
    <div class="met-index-product met-index-body text-xs-center" m-id="met_index_product">
        <div class="container">
            ...
            <ul class="
                ...
                <?php } ?>
                blocks-md-<?php echo $lang['index_product_column_md'];?> blocks-lg-<?php echo $lang['index_product_column_lg'];?> blocks-xxl-<?php echo $lang['index_product_column_xxl'];?> imagesize index-product-list clearfix" data-scale='<?php echo $lang['index_product_img_h'];?>X<?php echo $lang['index_product_img_w'];?>'>
                <?php
                    ...
                    <li class=''>
                        <div class="card card-shadow">
                            <figure class="card-header cover">
                                <a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" class="block" <?php echo $g['urlnew'];?>>
                                    <img class="cover-image lazy" data-original="<?php echo thumb($v['imgurl'],$lang[index_product_img_w],$lang[index_product_img_h]);?>" alt="<?php echo $v['title'];?>" >
                                </a>
                            </figure>
                            <a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" class="block txt-info" <?php echo $g['urlnew'];?>>
                                <h4 class="card-title m-0 p-x-10 text-shadow-none text-truncate">
                                    <?php echo $v['_title'];?>
                                </h4>
                                    <?php if($v['description']){ ?>
                                    <p class="m-b-0 text-truncate"><?php echo $v['description'];?></p>
                                <?php } ?>
    ...
    <div class="met-index-about met-index-body text-xs-center" m-id="met_index_about" m-type="nocontent">
        <div class="container">
            ...
            <?php } ?>
                ...
                <p class="desc m-b-0 font-weight-300 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['home_about_desc'];?></p>
            <?php } ?>
            <div class="row">
...
?>
                            <li class="invisible" data-plugin="appear" data-animate="slide-bottom" data-repeat="false">
                                <a class="media media-lg block" href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?>>
                                        <?php if($lang['home_news_img_ok']){ ?>
                                        <div class="media-left">
                                                <img class="media-object" data-original="<?php echo thumb($v['imgurl'],$lang[home_product_img_w],$lang[home_product_img_h]);?>" alt="<?php echo $v['title'];?>" >
                                        </div>
                                    <?php } ?>
                                    <div class="media-body">
                                        <h4 class="media-heading m-b-10"> <?php echo $v['_title'];?> </h4>
                                        <p class="des m-b-5"><?php echo met_substr($v['description'],0,$lang['home_news_img_maxnum']);?>...</p>
                                        <p class="info m-b-0">
                                            <span><?php echo $v['updatetime'];?></span>
                                            <span class="m-l-10"><?php echo $v['issue'];?></span>
                                            <span class="m-l-10">
    ...
    <div class="met-index-case met-index-body text-xs-center" m-id="met_index_case">
        <div class="container">
            ...
            <?php } ?>
                ...
                <p class="desc m-b-0 font-weight-300 invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><?php echo $lang['home_case_desc'];?></p>
            <?php } ?>
            <ul class="ulstyle met-index-list" data-num="<?php echo $lang['home_case_num_xxl'];?>|<?php echo $lang['home_case_num_lg'];?>|<?php echo $lang['home_case_num_md'];?>|<?php echo $lang['home_case_num_xs'];?>">
                <?php
