;(function() {
  ...
  function renderList(data) {
    ...
    <ul class="actions">
    <li class="btn-install"><i class="fa fa-cloud-download"><span class="ml-2">${METLANG.sys_purchase}</span></i>
  </ul>
  </div>
  </div>`
          html = html + card
        ...
        success: function(result) {
          ...
          metAjaxFun({
            ...
            true_fun: function() {
              ...
              }else $('.pageset-nav-modal .nav-modal-item .met-headtab a[href="#/myapp"]').click()
            },
            false_fun: function() {
