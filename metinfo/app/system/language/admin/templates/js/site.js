                    ...
                    dataSrc: function(result) {
                        ...
                        $.each(that.langData, function(index, val) {
                            let list = [
                                val.no_order,
                                val.name,
                                `<img src="${M.weburl}public/images/flag/${val.flag}" style="width:16px;height:11px;">`,
                        ...
                        modal
                            ...
                            .change(function(e) {
                                ...
                                if (value === '') {
                                    ...
                                    modal.find('#langflag').attr('src', `${M.weburl}public/images/flag/${value}.gif`)
                                }
                            })
            ...
            $.ajax({
                ...
                success: function(result) {
                    metui.use('webuipopover', function() {
                        ...
                        modal.find('#langflag-edit').attr('src', `${M.weburl}public/images/flag/${that.activeData.flag}`)
                        rednerFlag(result, modal)
                    })
                }
            })
