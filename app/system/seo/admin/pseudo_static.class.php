...
class pseudo_static extends admin
{
    ...
    private function createApacheHttpdurl($metbase = '')
    {
        ...
        $htaccess .= 'RewriteRule ^app/static/modules/ueditor/([a-zA-Z0-9_^\x00-\xff]+).html$ app/static/modules/ueditor/$1.html [L]' . "\n";
    ...
    private function createNginxHttpdurl($metbase = '')
    {
        ...
        $htaccess .= 'rewrite ^'.$metbase.'app/static/modules/ueditor/([a-zA-Z0-9_^\x00-\xff]+).html$ '.$metbase.'app/static/modules/ueditor/$1.html last;' . "\n";
    ...
    private function createIISHttpdurl($metbase = '')
    {
        ...
        $web .= '<match url="^/app/static/modules/ueditor/([a-zA-Z0-9_^\x00-\xff]+).html$" />' . "\n";
        $web .= '<action type="Rewrite" url="/app/static/modules/ueditor/$1.html" />' . "\n";
        $web .= '</rule>' . "\n";
    ...
    private function createHttpdurl($metbase = '')
    {
        ...
        $httpd .= 'RewriteRule ' . $metbase . 'app/static/modules/ueditor/([a-zA-Z0-9_^\x00-\xff]+).html ' . $metbase . 'app/static/modules/ueditor/$1.html' . "\n";
