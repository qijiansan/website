                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="row m-x-0">
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 text-xs-center">
                                        <button type="button" class="btn btn-primary btn-outline btn-squared {$_M['profile_safety']['emailclass']}" {$_M['profile_safety']['disabled']} data-target=".safety-modal-{$_M['profile_safety']['emailclass']}" data-toggle="modal" data-mailedit="{$url.emailedit}" data-mailadd="{$url.profile_safety_emailadd}">{$_M['profile_safety']['emailbut']}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
