...
class getpassword extends admin
{
    ...
    public function __construct()
    {
        ...
        $data = array(
            ...
            'met_agents_logo_login' => $_M['config']['met_agents_type'] >= 2 ? $_M['config']['met_agents_logo_login'] : $_M['url']['pub_new'] . 'images/login-logo.png',
    ...
    public function getPasswordByEmail($form = array())
    {
        ...
        if ($admin_list) {
            ...
            if ($_M['config']['met_agents_type'] <= 1) {
                $logo_url = "https://www.mituo.cn/upload/201812/1546050657.png";
